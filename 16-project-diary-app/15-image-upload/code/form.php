...
if (!empty($_POST)):
  ...
  if (!empty($_FILES) && !empty($_FILES['image'])):
    if ($_FILES['image']['error'] === 0 && $_FILES['image']['size'] !== 0):
      ...
      // Copy the submitted file and then scale it down 
  ...
  // 'Manually' redirect users a way to upload an image file back to the main page then terminate execution of the PHP program
